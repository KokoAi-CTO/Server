...
! function(e, a) {
    "object" == typeof exports && "undefined" != typeof module ? a(exports, require("@tensorflow/tfjs-node")) : "function" == typeof define && define.amd ? define(["exports", "@tensorflow/tfjs-node"], a) : a(e.cocoSsd = {}, e.tf)
}(this, function(e, a) {
    "use strict";
    ...
    var t = {
        ...
        m = "https://storage.googleapis.com/tfjs-models/savedmodel/";
    var d = function() {
        function e(e) {
            this.modelPath = "" + m + this.getPrefix(e) + "/model.json"
        }
    ...
    }, e.ObjectDetection = d, e.version = "0.1.1", Object.defineProperty(e, "__esModule", {
        value: !0
    })
});